package com.hhkbdev.khreact.config
...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, com.hhkbdev.khreact.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, com.hhkbdev.khreact.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, com.hhkbdev.khreact.domain.User::class.java.name)
            createCache(cm, com.hhkbdev.khreact.domain.Authority::class.java.name)
            createCache(cm, com.hhkbdev.khreact.domain.User::class.java.name + ".authorities")
