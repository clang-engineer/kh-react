...
import com.hhkbdev.khreact.config.ApplicationProperties
import com.hhkbdev.khreact.config.CRLFLogConverter
...
class KhReactApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<KhReactApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(KhReactApp::class.java)
